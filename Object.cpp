...
Object::Object(std::string name, void* shaderBytes, size_t shaderSize) : GameObject(name)
{
...
void Object::Draw(Matrix4x4 view, Matrix4x4 proj)
{
...
void Object::SetTexture(const wchar_t* file_path)
{
...
void Object::SetMesh(const wchar_t* file_path)
{
	this->mesh = GraphicsEngine::get()->getMeshManager()->createMeshFromFile(file_path);
	if (!mesh) throw std::exception("No mesh created");
}
